...
export const TableTodoComponent: FC<Props> = ({ todos }) => {
    ...
    const [filteredTodos, setFilteredTodos] = useState<M_Todo[]>(todos);
    ...
    return (
        <>
        <FormSearchTodo todos={filteredTodos} setTodos={setFilteredTodos}/>
